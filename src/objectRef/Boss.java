...
public class Boss extends Object{
	...
	public Boss(int hp,Color c, Game game,ImageLoader img) throws IOException {
		super(game.getWidth()/5,(int)(game.getWidth()*0.12), 0, game.getHeight()/2, hp, Type.Boss, game);
		totalHp=hp;
		vx=ws*0.00114;
